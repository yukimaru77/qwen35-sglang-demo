...
def main() -> None:
    out = Path(__file__).resolve().parents[1] / 'assets' / 'demo_image.png'
    ...
    draw.text((90, 80), 'Qwen3.5 + SGLang Vision Demo', font=font_big, fill=(20, 30, 50))
    draw.text((110, 450), 'blue rectangle', font=font_mid, fill=(20, 30, 50))
    draw.text((470, 420), 'red circle', font=font_mid, fill=(20, 30, 50))
    draw.text((720, 500), 'green triangle', font=font_mid, fill=(20, 30, 50))
    draw.text((110, 520), 'Expected answer: 3 colored shapes inside a white card.', font=font_mid, fill=(50, 60, 70))
    img.save(out)
    print(out)
