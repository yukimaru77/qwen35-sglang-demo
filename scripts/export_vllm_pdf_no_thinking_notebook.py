...
def main() -> None:
    nb = {
        'cells': [
            ...
            md_cell('## 2. PDF 全ページ text の non-thinking 要約'),
            ...
            md_cell('## 3. PDF 全ページ image の non-thinking 要約'),
    ...
    out = Path(__file__).resolve().parents[1] / 'notebooks' / 'vllm_pdf_no_thinking_quickstart.ipynb'
